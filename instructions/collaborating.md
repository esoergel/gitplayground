...
Pull any updates from the appropriate branch of the master remote repo, branch "playground" on "upstream" in this case.

    git pull upstream playground

This should say up-to-date or add changes with no problem.  You haven't been working 

### Checking out a remote branch

At this point, you should be tracking a remote repository, and you should be able to see a list of the branches over there with `git branch -r`.
